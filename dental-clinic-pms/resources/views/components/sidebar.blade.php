...
<aside
    class="bg-gray-800 text-gray-300 fixed top-0 left-0 z-40 flex flex-col w-64 transition-transform duration-300 transform lg:relative lg:translate-x-0 lg:transition-all"
    :class="{
