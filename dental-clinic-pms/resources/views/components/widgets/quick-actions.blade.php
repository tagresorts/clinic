<div class="bg-white p-6 rounded-lg shadow">
    ...
    <div class="space-y-2">
        @can('patient-create')
            <a href="{{ route('patients.create') }}" class="flex items-center p-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
        ...
        @can('treatment-plan-create')
            <a href="{{ route('treatment-plans.create') }}" class="flex items-center p-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
        ...
        @can('appointment-create')
            <a href="{{ route('appointments.create') }}" class="flex items-center p-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
        ...
        @endcan
        @can('operational-setting-list')
            <a href="{{ route('ops-settings.index') }}" class="flex items-center p-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
