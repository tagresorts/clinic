...
return new class extends Migration
{
    public function up()
    {
        ...
        // Insert supplier data only if it doesn't exist
        if (DB::table('suppliers')->where('id', 1)->doesntExist()) {
        ...
        // Insert inventory data only if it doesn't exist
        if (DB::table('inventory_items')->where('id', 1)->doesntExist()) {
