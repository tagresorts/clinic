    ...
    public static function build(): array
    {
        return [
            ...
            [
                ...
                'active' => request()->routeIs('users.*') || request()->routeIs('roles.*') || request()->routeIs('permissions.*') || request()->routeIs('smtp.*') || request()->routeIs('email-templates.*') || request()->routeIs('ops-settings.*') || request()->routeIs('logs.*'),
                'children' => [
