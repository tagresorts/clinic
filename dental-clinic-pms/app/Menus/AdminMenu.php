    ...
    public static function build(): array
    {
        return [
            ...
            [
                ...
                'active' => request()->routeIs('revenue.*') || request()->routeIs('invoices.*') || request()->routeIs('payments.*'),
                'children' => [
                    ['title' => 'Revenue Dashboard', 'url' => route('revenue.index'), 'active' => request()->routeIs('revenue.index')],
                    ['title' => 'Revenue Reports', 'url' => route('revenue.reports'), 'active' => request()->routeIs('revenue.reports')],
                    ['title' => 'Invoices', 'url' => route('invoices.index'), 'active' => request()->routeIs('invoices.index')],
                    ['title' => 'Payments', 'url' => route('payments.index'), 'active' => request()->routeIs('payments.index')],
                ],
                'can' => 'administrator',
            ],
            [
                ...
                'children' => [
                    ['title' => 'Reports Center', 'url' => route('reports.index'), 'active' => request()->routeIs('reports.index')],
                    ['title' => 'Patient Reports', 'url' => route('reports.patients'), 'active' => request()->routeIs('reports.patients')],
                    ['title' => 'Appointment Reports', 'url' => route('reports.appointments'), 'active' => request()->routeIs('reports.appointments')],
                    ['title' => 'Treatment Reports', 'url' => route('reports.treatments'), 'active' => request()->routeIs('reports.treatments')],
                    ['title' => 'Revenue Reports', 'url' => route('reports.revenue'), 'active' => request()->routeIs('reports.revenue')],
                ],
                'can' => 'administrator',
            ],
            [
